...
class ShapeDescriptor:
    ...
    def calculateParams( self ):
        ...
        if OB_PROP_DIMENSION_X in propMap.keys():
            self.width = propMap [ OB_PROP_DIMENSION_X ]
        else:
            self.width = 200
        if OB_PROP_DIMENSION_Y in propMap.keys():
            self.height = propMap [ OB_PROP_DIMENSION_Y ]
        else:
            self.height = 20
        ...
        self.olw = self.parentObject.getProperty( OB_PROP_OUTLINE_WIDTH )
