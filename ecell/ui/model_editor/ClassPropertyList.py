...
class ClassPropertyList( ViewComponent ):
    ...
    def getPropertySettable( self, aName ):
        if self.theType == 'Stepper':
            return self.theModelEditor.getModel().getStepperPropertyAttributes( self.theDisplayedEntity, aName )[MS_SETTABLE_FLAG]
        elif self.theType == 'Entity':
            fpn = self.theDisplayedEntity + ':' + aName
            return self.theModelEditor.getModel().getEntityPropertyAttributes( fpn )[MS_SETTABLE_FLAG]
        else:
            return None
    ...
    def getPropertyDeleteable( self, aName ):
        if self.theType == 'Stepper':
            return self.theModelEditor.getModel().getStepperPropertyAttributes( self.theDisplayedEntity, aName )[MS_DELETEABLE_FLAG]
        elif self.theType == 'Entity':
            fpn = self.theDisplayedEntity + ':' + aName
            return self.theModelEditor.getModel().getEntityPropertyAttributes( fpn )[MS_DELETEABLE_FLAG]
        else:
            return None
    ...
    def getPropertySaveable( self, aName ):
        if self.theType == 'Stepper':
            return self.theModelEditor.getModel().getStepperPropertyAttributes( self.theDisplayedEntity, aName )[MS_SAVEABLE_FLAG]
        elif self.theType == 'Entity':
            fpn = self.theDisplayedEntity + ':' + aName
            return self.theModelEditor.getModel().getEntityPropertyAttributes( fpn )[MS_SAVEABLE_FLAG]
        else:
            return None
    ...
    def getPropertyLoadable( self, aName ):
        if self.theType == 'Stepper':
            return self.theModelEditor.getModel().getStepperPropertyAttributes( self.theDisplayedEntity, aName )[MS_LOADABLE_FLAG]
        elif self.theType == 'Entity':
            fpn = self.theDisplayedEntity + ':' + aName
            return self.theModelEditor.getModel().getEntityPropertyAttributes( fpn )[MS_LOADABLE_FLAG]
        else:
            return None
...
self.theDisplayedEntity, self.theSelection )
    ...
    def changeValue( self, newValue, anIter ):
        ...
        if aCommand.isExecutable():
            ...
            utils.showPopupMessage( "Illegal value for %s" % aName, ME_ERROR )
