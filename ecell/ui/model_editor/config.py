...
doc_dir = os.path.join( data_dir, package_local )

recent_file_list_file = os.path.join(
    user_prefs_dir,  RECENTFILELIST_FILE_NAME  )

canvas_peer = 'gnomecanvas'
