...
from ecell.ui.model_editor.LayoutBufferFactory import LayoutBufferFactory, LayoutBufferPaster
from ecell.ui.model_editor.PathwayCanvas import PathwayCanvas
...
class ObjectIterator:
    ...
    def doesComply( self, anObject ):
        ...
        for aFilter in self.filterList:
            if aFilter[0] == "FULLID" and OB_PROP_FULLID in propertyList:
                if aFilter[1] == anObject.getProperty( OB_PROP_FULLID ):
                    complied += 1
