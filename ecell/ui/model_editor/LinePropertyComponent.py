...
class  LinePropertyComponent(ViewComponent):
    ...
    def __ColorFillSelection_displayed( self,*args):
        ...
        if response==gtk.RESPONSE_OK:
            ...
            self.__LineProperty_updated(OB_PROP_FILL_COLOR,self.theHex)
        else:
            aDialog.destroy()
    ...
    def populateComboBox(self,anObject):
        ...
        anObjArrowType = anObject.getProperty(OB_PROP_SHAPE_TYPE)
    ...
    def setDisplayedLineProperty(self ,connObj):
        ...
        self.theFillColor=self.getColorObject(self.theObject.getProperty(OB_PROP_FILL_COLOR))
    ...
    def changeArwType(self, newArwType):
        if newArwType!="" and  self.theObject.getProperty(OB_PROP_SHAPE_TYPE) != newArwType:
            self.__LineProperty_updated(OB_PROP_SHAPE_TYPE,newArwType)
