...
class LayoutEml:
    ...
    def __init__( self, aFileObject=None ):
        ...
        self.theDocument = minidom.parseString( aStringData )
#       self.__clearCache()
        self.__reconstructCache()

    def destroy( self ):
        self.theDocument.unlink()

    def asString( self ):
        """return domtree as string"""

        return self.theDocument.toprettyxml(indent="", newl="\n")
    ...
    def createLayout( self, aName ):
        ...
        self.theDocument.documentElement.childNodes.append( aLayoutElement )
    ...
    def __reconstructCache( self ):
        ...
        self.__clearCache()
        for aLayoutNode in self.theDocument.firstChild.childNodes:
    ...
    def __createElement( self, aTagName ):
        """make an element"""
        return self.theDocument.createElement( aTagName )
    ...
    def __createValueNode( self, aValue ):
        ...
        if type( aValue ) in ( types.TupleType, types.ListType ):   # vector value
            ...
            aValueData = self.theDocument.createTextNode( aNormalizedValue )
...
#        self.__clearCache()
    ...
    def createStepper( self, aClass, anID ):
        ...
        self.theDocument.documentElement.childNodes.append( aStepperElement )
    ...
    def deleteStepper( self, anID ):
        ...
        for anElement in self.theDocument.getElementsByTagName("eml")[0].childNodes:
    ...
    def __getStepperNodeList( self ):
        ...
        for aTargetNode in self.theDocument.documentElement.childNodes:
    ...
    def createEntity( self, aClass, aFullID ):
        ...
        if( anEntityType == 'System' ):
            ...
            self.theDocument.documentElement.appendChild( anEntityElement )
        ...
        if aType == 'System':
            for anElement in self.theDocument.getElementsByTagName("eml")[0].childNodes:
                ...
                if convertSystemID2SystemFullID( anElement.getAttribute( 'id' ) ) == aFullID:
                    self.theDocument.getElementsByTagName("eml")[0].removeChild( anElement )
    ...
    def getEntityList( self, anEntityType, aSystemPath ):
        ...
        if aType == 'system':
            ...
            for aSystemNode in self.theDocument.getElementsByTagName("eml")[0].childNodes:
    ...
    def getEntityProperty( self, aFullPNString ):
        ...
        aFullPN = convertFullIDStringToFullPNString( aFullPNString )
        aPropertyName = aFullPN[3]
        aFullID = convertFullIDStringToFullPNStringString( convertFullPNToFullID( aFullPN ) )
    ...
    def __reconstructCache( self ):
        anEML = self.theDocument.getElementsByTagName("eml")
        if len(anEML) == 0:
    ...
    def __createInfoNode ( self, InfoStrings ):
        ...
        anInfoData = self.theDocument.createTextNode( InfoStrings )
