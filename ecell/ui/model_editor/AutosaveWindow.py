...
from ViewComponent import ViewComponent
...
class AutosaveWindow:
        def __init__(self, aModelEditor, aDuration):
            ...
            self.___num = utils.CANCEL_PRESSED
            self.__off = False
                ...
                if self.ViewComponentObject['set_duration'].get_active() == True:      
                    try:
                        ...
                        utils.showPopupMessage(
                            utils.OK_MODE, 
                            "Please enter a positive integer value for " + \
                            "time duration", ME_ERROR )
                        return None
                else:
                    try:
                        ...
                        utils.showPopupMessage(
                            utils.OK_MODE,
                            "Please enter a positive integer for number of "
                            + "operations", ME_ERROR )
                        return None    
