...
class ListWindow(Window):
    ...
    def move( self, xpos, ypos ):
        ...
        if self.exists():
            if self.isStandalone:
                self[self.__class__].move( xpos, ypos)
    ...
    def resize( self, width, heigth ):
        ...
        if self.exists():
            if self.isStandalone:
                self[self.__class__].resize( width, heigth)
