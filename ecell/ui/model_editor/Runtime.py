...
class ResultsWindow:
        ...
        if self.theBoardWindow != None:
            ...
            for aPlugin in self.thePluginList.values():
                ...
                for afullPN in fullPNList:
                    fullPNStringList.append(
                        ecell.util.convertFullIDStringToFullPNStringString( afullPN ) )
    ...
    def createTracer( self, aFullPNStringList ):
        ...
        for aFullPNString in aFullPNStringList:
            aFullPNList += [ ecell.util.convertFullIDStringToFullPNString( aFullPNString ) ]
